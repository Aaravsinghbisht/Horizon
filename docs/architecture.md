# Horizon — System Flow & Architecture (Detailed)

This document explains how **Horizon / Compositer** works end-to-end: the Eve agent, live browser panel, human-in-the-loop (HITL), site safety scanner, Razorpay checkout, and user takeover. It is the companion to the [`README.md`](../README.md) (setup and quick start).
